...
\begin{minipage}{0.4\textwidth}
	...
	\begin{tikzpicture}
		...
		\draw[line width = .8mm, arrows = {-Stealth}, cyan] (180+\Beta:1) -- ++(180+\Beta:2) node[midway, right] {$N_9$};
		\draw[black] (0, -2) arc[start angle=-\Beta, end angle=0, radius=2] node[midway, anchor=south west, font=\huge] {$\beta$};
